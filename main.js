...
var geneButton = (function() {
	...
	element.onclick = function() {
        ...
        //地面
            ...
            .replace(/([\[,])208(?!\d)/g, '$1' + '293')//地面中
            .replace(/([\[,])209(?!\d)/g, '$1' + '293')//地面中
            .replace(/([\[,])210(?!\d)/g, '$1' + '293')//地面中
            ...
            //水（点）
            .replace(/([\[,])42(?!\d)/g, '$1' + '387')

			//石床
            .replace(/([\[,])174(?!\d)/g, '$1' + '64')//石床
            .replace(/([\[,])192(?!\d)/g, '$1' + '64')//石床
            ...
            .replace(/([\[,])1(?!\d)/g, '$1' + '384')//水左
            .replace(/([\[,])72(?!\d)/g, '$1' + '1')//草
            .replace(/([\[,])73(?!\d)/g, '$1' + '1')//草
            .replace(/([\[,])74(?!\d)/g, '$1' + '1')//草
            .replace(/([\[,])75(?!\d)/g, '$1' + '1')//草
            .replace(/([\[,])90(?!\d)/g, '$1' + '1')//草
			.replace(/([\[,])106(?!\d)/g, '$1' + '1')//草
			.replace(/([\[,])107(?!\d)/g, '$1' + '1')//草
			.replace(/([\[,])108(?!\d)/g, '$1' + '1')//草
            .replace(/([\[,])124(?!\d)/g, '$1' + '1')//草
